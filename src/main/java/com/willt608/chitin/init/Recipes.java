...
public class Recipes {
    ...
    public static void preInit() {
        GameRegistry.addRecipe(
            new ShapedOreRecipe(new ItemStack(chitinSword), "C", "C", "/", 'C', chitinShell, '/', Items.stick));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(new ItemStack(chitinShovel), "C", "/", "/", 'C', chitinShell, '/', Items.stick));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(new ItemStack(chitinPickaxe), "CCC", " / ", " / ", 'D', Blocks.dirt, '/', Items.stick));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(new ItemStack(chitinAxe), "CC", "C/", " /", 'C', Blocks.dirt, '/', Items.stick));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(new ItemStack(chitinHoe), "CC", " /", " /", 'C', Blocks.dirt, '/', Items.stick));
    }
}
